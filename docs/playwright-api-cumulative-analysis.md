...
- `playwright-recorder/captures/api-summary-2026-05-16T13-01-14-850Z.json`
- `playwright-recorder/captures/api-summary-2026-05-16T15-12-38-151Z.json`

## Ergebnis

- Aufnahmen: 9
- Eindeutige Endpunkte: 141
- Methoden: GET 101, POST 34, PUT 3, HEAD 1, PATCH 1, DELETE 1
- Statuscodes: 200 1317, 201 12, 404 2, 500 2

## Service-Gruppen

- `/apigateway/wawi`: 21 Endpunkte
...
- `GET` `/apigateway/accounting/material-groups` (2 Calls, 200 2)
  - Query: `size`
...
- `GET` `/apigateway/accounting/material-groups/{uuid}` (2 Calls, 200 2)
...
- `GET` `/apigateway/accounting/payment-terms` (33 Calls, 200 33)
...
- `GET` `/apigateway/article-tenant/articles/{uuid}` (6 Calls, 200 6)
...
- `GET` `/apigateway/article-tenant/articles/{uuid}/computed-order-value/{id}` (3 Calls, 200 3)
...
- `GET` `/apigateway/article-tenant/articles/{uuid}/details/{uuid}` (2 Calls, 404 2)
...
- `GET` `/apigateway/article-tenant/articles/{uuid}/merchandise-management-setting` (10 Calls, 200 10)
  - Response: `{ enabled: boolean; articleId: string }`
- `GET` `/apigateway/article-tenant/articles/{uuid}/price-data` (2 Calls, 200 2)
...
- `GET` `/apigateway/article-tenant/articles/{uuid}/supplier-assignments` (2 Calls, 200 2)
  - Query: `size`
...
- `POST` `/apigateway/article-tenant/articles/merchandise-management-setting` (28 Calls, 200 28)
  - Request: `string[]`
...
- `POST` `/apigateway/article-tenant/articles/search` (7 Calls, 200 7)
  - Query: `page`, `size`
...
- `GET` `/apigateway/article-tenant/label-configurations/{uuid}` (2 Calls, 200 2)
...
- `GET` `/apigateway/articletenantservice/articles/{uuid}` (1 Calls, 200 1)
  - Response: `{ migratedId: null; articleNumber: string; dataOrigin: string; description: string; cloudDescription: string; producer: { label: string; id: string }; color: string; side: null; barcodeNr: null; pzn: string; active: boolean; hmvNr: string; eanCode: string; serviceTypes: unknown[]; validation: null; priceData: { suggestedRetailPrice: integer; sellingPrice: null; vatRateKey: string; quantityUnit: string; wirtschaftlicheAufzahlung: boolean; purchasePrice: integer; purchasePriceActual: integer; comp...`
- `GET` `/apigateway/articletenantservice/articles/search/{id}` (6 Calls, 200 6)
...
- `GET` `/apigateway/communicatorservice/reminders/dbopt` (10 Calls, 200 10)
...
- `GET` `/apigateway/country/countries` (8 Calls, 200 8)
  - Query: `hasState`, `size`
...
- `GET` `/apigateway/department/departments` (26 Calls, 200 26)
...
- `GET` `/apigateway/document/stored-documents` (15 Calls, 200 15)
...
- `GET` `/apigateway/enum-service/enums` (8 Calls, 200 8)
  - Response: `{ enumType: string; data: { key: string; label: string; tvalue: null }[] }[]`

### /apigateway/file-archive

- `GET` `/apigateway/file-archive/file-archive/load/files/{uuid}` (10 Calls, 200 10)
  - Query: `apiHash`
- `HEAD` `/apigateway/file-archive/file-archive/load/files/{uuid}` (10 Calls, 200 10)
- `POST` `/apigateway/file-archive/file-archive/upload/files` (2 Calls, 201 2)
  - Response: `{ fileId: string }`

### /apigateway/filiale

- `GET` `/apigateway/filiale/filialen` (62 Calls, 200 62)
...
- `GET` `/apigateway/filiale/filialen/{uuid}` (15 Calls, 200 15)
...
- `GET` `/apigateway/filiale/filialen/{uuid}/addresses` (13 Calls, 200 13)
  - Query: `size`
...
- `GET` `/apigateway/filiale/filialen/{uuid}/institutionskennzeichen` (8 Calls, 200 8)
  - Query: `size`
...
- `GET` `/apigateway/filiale/filialen/{uuid}/institutionskennzeichen/{uuid}` (8 Calls, 200 8)
...
- `GET` `/apigateway/firma/companies/contact-opportunities` (15 Calls, 200 15)
...
- `GET` `/apigateway/firma/companies/details` (2 Calls, 200 2)
...
- `GET` `/apigateway/firma/companies/details/addresses` (4 Calls, 200 4)
  - Query: `size`
  - Response: `{ content: { street: string; streetNumber: string; zipCode: string; city: string; addressAdditional: null; poBox: string; mainAddress: boolean; dateValidFrom: string; dateValidTo: null; active: boolean; id: string; addressType: string; stateId: null; countryId: null }[]; pageable: { pageNumber: integer; pageSize: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; ascending: boolean; descending: boolean }[]; offset: integer; paged: boolean; unpaged: b...`
...
- `GET` `/apigateway/hilfsmittel/hilfsmittel/termine` (17 Calls, 200 17)
...
- `GET` `/apigateway/kostentraeger-tenant/kostentraeger/{uuid}` (9 Calls, 200 9)
...
- `GET` `/apigateway/kostentraeger-tenant/kostentraeger/{uuid}/notes` (10 Calls, 200 10)
  - Query: `size`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; paged: boolean; unpaged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `GET` `/apigateway/kostentraeger-tenant/kostentraeger/cloud-status` (8 Calls, 200 8)
  - Query: `ik`
  - Response: `{ exists: boolean }`

### /apigateway/kunden

- `GET` `/apigateway/kunden/customers/{uuid}` (11 Calls, 200 11)
  - Response: `{ customerNumber: integer; title: null; salutation: string; firstName: string; lastName: string; dateOfBirth: string; birthName: null; versichertennummer: string; migratedId: null; phoneNumbers: unknown[]; email: null; faxConnection: null; dateOfDeath: null; fiBuAccountNumber: integer; gdprSigned: boolean; active: boolean; taxIdentificationNumber: null; employee: boolean; shoeSize: null; insolesSize: null; ... }`
- `GET` `/apigateway/kunden/customers/{uuid}/addresses` (16 Calls, 200 16)
  - Query: `size`
...
- `GET` `/apigateway/kunden/customers/{uuid}/arzt` (12 Calls, 200 12)
  - Query: `size`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; paged: boolean; unpaged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
...
- `GET` `/apigateway/kunden/customers/{uuid}/kostentraeger` (15 Calls, 200 15)
  - Query: `size`
...
- `GET` `/apigateway/kunden/customers/{uuid}/notes` (10 Calls, 200 10)
  - Query: `showHint`, `size`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; paged: boolean; unpaged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `GET` `/apigateway/kunden/customers/search` (36 Calls, 200 36)
...
- `GET` `/apigateway/mail/gateway-configurations/user-mail-addresses` (8 Calls, 200 8)
  - Response: `unknown[]`
- `GET` `/apigateway/mail/mails/unread-number` (52 Calls, 200 52)
  - Response: `unknown[]`

### /apigateway/navigation

- `GET` `/apigateway/navigation/navigations/details` (8 Calls, 200 8)
...
- `GET` `/apigateway/notification/notifications` (8 Calls, 200 8)
...
- `POST` `/apigateway/sales/art/search` (10 Calls, 200 10)
  - Query: `page`, `size`, `sort`
...
- `POST` `/apigateway/sales/salesprocesses` (4 Calls, 201 4)
...
- `GET` `/apigateway/sales/salesprocesses/{uuid}` (3 Calls, 200 3)
...
- `PUT` `/apigateway/sales/salesprocesses/{uuid}` (19 Calls, 200 19)
...
- `GET` `/apigateway/sales/salesprocesses/{uuid}/invoices` (2 Calls, 200 2)
  - Query: `invoiceType`
  - Response: `unknown[]`
- `GET` `/apigateway/sales/salesprocesses/{uuid}/notes` (7 Calls, 200 7)
  - Query: `size`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; paged: boolean; unpaged: boolean }; totalElements: integer; totalPages: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
...
- `POST` `/apigateway/sales/salesprocesses/calculate-prices` (10 Calls, 200 10)
  - Request: `{ active: boolean; vorgangssperre: boolean; id: string; salesProcessType: string; number: integer; editorId: string; editorType: string; editorName: string; customerId: string; customerName: string; customerLastName: string; customerFirstName: string; customerTitle: null; customerDateOfBirth: string; customerStreet: null; customerHouseNumber: null; customerZipCode: null; customerCity: null; customerVersichertennummer: string; customerPhoneNumberPrivate: null; ... }`
  - Response: `{ salesProcessType: string; totalGross: integer; totalNet: number; totalGrossCustomerPortion: integer; totalGrossKostentraegerPortion: integer; totalVat: number; totalCoupon: integer; totalPrice: integer; totalZuzahlung: integer; totalEigenanteil: integer; totalWirtschaftlicheAufzahlung: integer; totalGrossPrivatePositions: integer; totalGrossKostentraegerPositions: integer; totalPositionsDiscount: integer; totalPositionsVoucher: integer; zulage: integer; zuzahlungsbefreit: boolean; useHilfsmitt...`
- `GET` `/apigateway/sales/salesprocesses/kpi-statistics` (18 Calls, 200 18)
  - Response: `{ sum: integer; statusId: string }[]`
- `POST` `/apigateway/sales/salesprocesses/search` (20 Calls, 200 20)
  - Query: `page`, `size`, `sort`
...
- `GET` `/apigateway/salesprocessservice/dv-data/customer/{uuid}/dv-ids` (1 Calls, 200 1)
  - Response: `string[]`
- `POST` `/apigateway/salesprocessservice/invoices/search` (7 Calls, 200 7)
  - Query: `page`, `size`
  - Request: `{ customerInvoiceFilter: { number: string }; invoiceFilter: { types: string[]; statuses: string[] } }`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; paged: boolean; unpaged: boolean }; totalElements: integer; totalPages: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `GET` `/apigateway/salesprocessservice/recommendations` (5 Calls, 200 5)
  - Query: `filialeId`
...
- `GET` `/apigateway/salesprocessservice/salesprocesses/customer/{uuid}/vorgang-ids` (1 Calls, 200 1)
  - Response: `string[]`
- `POST` `/apigateway/salesprocessservice/status/search` (24 Calls, 200 24)
  - Query: `size`
  - Request: `{  }`
...
- `GET` `/apigateway/supplier/suppliers` (41 Calls, 200 41)
...
- `GET` `/apigateway/supplier/suppliers/{uuid}` (9 Calls, 200 9)
...
- `GET` `/apigateway/supplier/suppliers/{uuid}/addresses` (15 Calls, 200 15)
  - Query: `size`
...
- `GET` `/apigateway/supplier/suppliers/{uuid}/contact-opportunities` (15 Calls, 200 15)
...
- `GET` `/apigateway/supplier/suppliers/{uuid}/contacts` (15 Calls, 200 15)
  - Query: `size`
...
- `GET` `/apigateway/supplier/suppliers/{uuid}/customers` (15 Calls, 200 15)
  - Query: `singleDisplay`
  - Response: `unknown[]`
- `POST` `/apigateway/supplier/suppliers/list` (2 Calls, 200 2)
  - Request: `unknown[]`
  - Response: `unknown[]`
- `GET` `/apigateway/supplier/suppliers/search` (2 Calls, 200 2)
  - Query: `active`, `keywords`, `page`, `size`, `sort`
...
- `GET` `/apigateway/task/tasks/reminder-count` (8 Calls, 200 8)
  - Response: `integer`
- `GET` `/apigateway/task/tasks/task-count` (52 Calls, 200 52)
  - Response: `integer`

### /apigateway/user

- `GET` `/apigateway/user/generic-list-column-states` (8 Calls, 200 8)
...
- `GET` `/apigateway/user/users` (9 Calls, 200 9)
  - Query: `size`
...
- `GET` `/apigateway/user/users/{uuid}/dashboards` (8 Calls, 200 8)
  - Response: `{ id: string; configuration: string }`
- `GET` `/apigateway/user/users/search` (26 Calls, 200 26)
  - Query: `active`, `keywords`, `page`, `size`, `sort`
  - Response: `{ pageable: { pageNumber: integer; pageSize: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; ascending: boolean; descending: boolean }[]; offset: integer; paged: boolean; unpaged: boolean }; size: integer; content: { id: string; username: string; active: boolean; standardPassword: boolean; firstName: string; lastName: string; email: null; salutation: string; phoneNumber: null; mobilePhoneNumber: null; userNumber: integer; favoriteAppIds: unknown[]...`

### /apigateway/user-details

- `GET` `/apigateway/user-details` (8 Calls, 200 8)
...
- `GET` `/apigateway/userservice/companies/details/preferences` (9 Calls, 200 9)
...
- `GET` `/apigateway/userservice/feature-toggles` (8 Calls, 200 8)
...
- `POST` `/apigateway/userservice/metrics/user-login` (18 Calls, 200 18)
  - Request: `{ username: string; tenantId: string; tokenDuration: number; userDetailsDuration: number; totalDuration: number }`
- `GET` `/apigateway/userservice/user/preferences` (6 Calls, 200 6)
  - Response: `{ flags: { multiWordSearch: boolean } }`
- `GET` `/apigateway/userservice/workspaces/{uuid}` (8 Calls, 200 8)
...
- `POST` `/apigateway/userservice/workspaces/log` (8 Calls, 200 8)
  - Request: `{ electronVersion: string; hostname: string; ip: string; startup: string; username: string }`

### /apigateway/vatrates

- `GET` `/apigateway/vatrates/vatrates` (8 Calls, 200 8)
  - Query: `all`
...
- `GET` `/apigateway/wawi/cost-centers` (23 Calls, 200 23)
  - Query: `size`
...
- `GET` `/apigateway/wawi/delivery-terms/search` (25 Calls, 200 25)
  - Query: `active`, `keywords`, `paged`, `size`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; unpaged: boolean; paged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `POST` `/apigateway/wawi/incoming-invoices/search` (7 Calls, 200 7)
  - Query: `size`
...
- `POST` `/apigateway/wawi/order-arrival/search` (40 Calls, 200 40)
  - Query: `page`, `size`, `sort`
  - Request: `{ keywords: string; active: boolean; orderNr: string; arrivalBookingState: string }`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; unpaged: boolean; paged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `POST` `/apigateway/wawi/order-proposals` (2 Calls, 201 2)
...
- `POST` `/apigateway/wawi/order-proposals/search` (8 Calls, 200 8)
  - Query: `page`, `size`, `sort`
...
- `POST` `/apigateway/wawi/order-proposals/search/sums` (7 Calls, 200 7)
  - Request: `{ keywords: string; active: boolean }`
  - Response: `{ orderQuantity: { PIECE: integer; PACK: integer }; orderValue: number; sumOrderQuantity: integer }`
- `POST` `/apigateway/wawi/order-proposals/to-order` (7 Calls, 200 7)
  - Request: `{ includeAll: boolean; selections: string[]; filters: null }`
  - Response: `unknown[]`
- `GET` `/apigateway/wawi/order-states` (29 Calls, 200 29)
  - Query: `active`, `keywords`, `page`, `size`, `sort`
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; unpaged: boolean; paged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `GET` `/apigateway/wawi/orders/{uuid}` (17 Calls, 200 17)
...
- `PUT` `/apigateway/wawi/orders/{uuid}` (1 Calls, 200 1)
  - Request: `{ id: string; number: string; active: boolean; orderingPlatform: string; orderType: string; billingAddressId: null; deliveryAddressId: null; deliveryDate: null; deliveryDateScheduled: null; deliveryTermsId: null; deliveryNumber: null; editorId: string; editorName: null; filialeId: null; filialeName: null; mailFooter: null; mailHeader: null; orderDate: null; timestampUpdated: null; orderQuantity: null; ... }`
...
- `POST` `/apigateway/wawi/orders/{uuid}/email` (2 Calls, 200 2)
...
- `GET` `/apigateway/wawi/orders/{uuid}/positions` (31 Calls, 200 31)
...
- `POST` `/apigateway/wawi/orders/{uuid}/process-order` (2 Calls, 200 2)
...
- `POST` `/apigateway/wawi/orders/from-proposal` (6 Calls, 200 4, 500 2)
...
- `POST` `/apigateway/wawi/orders/search` (8 Calls, 200 8)
  - Query: `page`, `size`, `sort`
  - Request: `{ keywords: string; active: boolean }`
...
- `GET` `/apigateway/wawi/producers` (21 Calls, 200 21)
...
- `GET` `/apigateway/wawi/stock-items` (2 Calls, 200 2)
  ...
  - Response: `{ content: unknown[]; pageable: { sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; offset: integer; pageNumber: integer; pageSize: integer; unpaged: boolean; paged: boolean }; totalPages: integer; totalElements: integer; last: boolean; size: integer; number: integer; sort: { direction: string; property: string; ignoreCase: boolean; nullHandling: string; descending: boolean; ascending: boolean }[]; numberOfElement...`
- `GET` `/apigateway/wawi/storage-locations` (32 Calls, 200 32)
...
- `GET` `/apigateway/wawi/storage-locations/{uuid}` (2 Calls, 200 2)
...
- `POST` `/apigateway/wawiservice/order-arrival/book` (2 Calls, 200 2)
...
- `GET` `/apigateway/wawiservice/orders/customer/{uuid}/order-ids` (1 Calls, 200 1)
  - Response: `string[]`
- `POST` `/apigateway/wawiservice/stock-items/count-article-quantities` (7 Calls, 200 7)
